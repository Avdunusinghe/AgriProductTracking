...
export const sidenavMenuItems = [ 
    ...
    new SidenavMenu (65, 'Landing', '/landing', null, null, false, 60), 
    new SidenavMenu (80, 'Contact', '/contact', null, null, false, 0),  
    new SidenavMenu (90, 'Admin Panel', '/admin', null, null, false, 0),  
    ...
    new SidenavMenu (40, 'Users', '/admin/users', null,  null, false, 0),  
    new SidenavMenu (50, 'Customers', '/admin/customers', null,  null, false, 0),  
]